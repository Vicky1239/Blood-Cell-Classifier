# -*- coding: utf-8 -*-
"""
Created on Sun Nov 18 18:57:51 2018
...
def get_data(folder):
    ...
    z = np.asarray(z)
    return X,y,z
X_train, y_train, z_train = get_data('C:/Users/DELL/Desktop/blood-cells/dataset2-master/images/TRAIN/')
X_test, y_test, z_test = get_data('C:/Users/DELL/Desktop/blood-cells/dataset2-master/images/TEST/')
